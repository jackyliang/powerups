...
---
<!-- Generated by scripts/sync-devin-skills.py from plugins/powerups/skills/user-research/SKILL.md. Do not edit. -->
...
- `plan-driven-development` runs this BEFORE writing the plan, whenever
...
- `give-me-five` runs this BEFORE brainstorming directions — all five
