...
---
<!-- Generated by scripts/sync-devin-skills.py from plugins/powerups/skills/bug-fix/SKILL.md. Do not edit. -->
...
**This skill invokes `best-practices`** — branching, investigation, TDD, and all other practices apply. This skill adds bug-specific discipline on top.
...
Run the finishing sequence from `best-practices` practice #9: `/simplify`, `change-log` (skip if the fix isn't user-facing), `update-docs`, and lint. The full test suite already ran in Step 7.
