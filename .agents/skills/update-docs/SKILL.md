...
3. **Blog/changelog** — is there an announcement for a shipped user-visible feature? If not, flag it and hand off to `marketing-surfaces` (this skill doesn't write posts).
