...
| Piece | Owner |
|---|---|
| Maintainer docs — CLAUDE.md, README, `docs/`, sibling-repo dev docs | `powerups:update-docs` |
| `CHANGELOG.md` entry (in the feature PR) | `powerups:change-log` |
| How a product image is captured, cleaned and composited | `powerups:mockups` |
| Plain-language gate on every text surface | `powerups:simple-design-principles` |
